...
from pettingzoo.mpe import simple_tag_v3, simple_adversary_v3, simple_spread_v3, simple_crypto_v3, \
    simple_speaker_listener_v4 , simple_v3
from utils import plot_all_agents_rewards, plot_average_episode_rewards,plot_all_agents_rewards_smooth
...
if __name__ == '__main__':
    ...
    # parallel_env, scenario =  simple_adversary_v3.parallel_env(N=2 ,max_cycles=25, continuous_actions=True, render_mode="rgb_array"), "Cooperative_Communication"
    print(scenario)
    N_GAMES = 10_000
